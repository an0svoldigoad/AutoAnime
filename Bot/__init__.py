...
BOT_TOKEN = environ.get('BOT_TOKEN', '6546232482:AAFQQl2gF2tWXVkcXG0AL8BPHI-Q6VGn3p0') #BOT TOKEN
...
MESSAGE_ID = int(environ.get('MESSAGE_ID', -1001901228886)) #SUB CHANNEL STATUS ID
